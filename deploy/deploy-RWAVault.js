// deploy: npx hardhat deploy --network <NETWORK_NAME> --tags RWAVault
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	{
		// deploy if required
		await deployments.deploy("RWAVault", {
		...
		const deployment = await deployments.get("RWAVault");
...
module.exports.tags = ["RWAVault", "deploy"];